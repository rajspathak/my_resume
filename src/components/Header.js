...
const Header = () => (
  <header className="header">
    <div className="header-content">
      ...
      <div className="image-container" style={{ paddingRight:40, padding:50, backgroundColor:"red"}}>
        <img src={ProfileIcons} alt="Raj Pathak" className="profile-image"  style={{backgroundColor:"green"}}/>
      </div>
    </div>
  </header>
);
